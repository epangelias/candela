...
export const handler = define.handlers({
  GET: async (ctx) => {
    ...
    const prompt = query.split(' ').length > 1
      ...
      : `You will provide a helpful definition for the word. The beginning of your response will be a list of 1-3 words separated by a comma that signify the meaning of the word. After that, a "." and relevant grammatical, etymological, or contextual insights in only 10 words. The selection will be in the language: ${user.language}, and your answer will be in the language ${user.nativeLanguage}`;
